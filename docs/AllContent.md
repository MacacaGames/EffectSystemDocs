Script API : [Document](https://macacagames.github.io/EffectSystem/) 
Document : 
...
## EffectType
EffectType is the basic unit that defines a feature during runtime, such as AddAtkPoint, AddAtkRatio, AddBlockChance, etc.
